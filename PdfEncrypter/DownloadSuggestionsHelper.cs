...
namespace PdfEncrypter
{
    class DownloadSuggestionsHelper
    {
        ...
        public void SetupDownloadMenuItems(ToolStripMenuItem tsiDownload)
        {
            ...
            Url.Add("http://www.4dots-software.com/d/FreeAudioConverter/");

            Url.Add("http://www.4dots-software.com/d/SimpleMP3CutterJoinerEditor/");

            Url.Add("http://www.4dots-software.com/d/MP3JoinerExpert/");
            ...
            Url.Add("http://www.4dots-software.com/d/SimpleDisableKey/");
