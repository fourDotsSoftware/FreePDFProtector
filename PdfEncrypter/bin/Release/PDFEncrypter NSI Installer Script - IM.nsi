...
;copy translations end
  ...
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Free PDF Protector 4dots"
  !define PRODUCT_SHORTCUT "Free PDF Protector 4dots"
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Free PDF Protector 4dots - User's Manual.url.lnk" "$INSTDIR\Free PDF Protector 4dots - User's Manual.url" "" "$INSTDIR\Free PDF Protector 4dots - User's Manual.url" 0
...
;  inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/PDFEncrypter.php" "$PLUGINSDIR\Installmanager.exe" /end
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Free PDF Protector 4dots - User's Manual.url"
;  File "readme.txt"
  ;File "..\..\..\helpfile\Free PDF Protector 4dots - User's Manual.url";
  ...
  ;File "free-pdf-protector-4dots-150.png"
  ...
  ;nsExec::Exec "$INSTDIR\net_updater32.exe --install win_pdfencrypter.4dotssoftware.com"
...
${EndIf}  
 ...
 ;nsExec::Exec "$INSTDIR\net_updater32.exe --uninstall win_pdfencrypter.4dotssoftware.com" 
...
Function .onInstSuccess
	ExecShell "" "http://www.4dots-software.com/free-pdf-protector/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
FunctionEnd

Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/free-pdf-protector/how-to-use.php?afterinstall=true"
FunctionEnd
