...
namespace PdfEncrypter
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                string regval = RegistryHelper2.GetKeyValue("Free PDF Protector 4dots", "LuminatiChoice");
        ...
        public static void InitRegistryLuminati()
        {
            if (Properties.Settings.Default.FirstTimeRun)
            {
                ...
                proc2.StartInfo.Arguments = "-clearchoice \"Free PDF Protector 4dots\"";
            ...
            RegistryHelper2.SetKeyValue("Free PDF Protector 4dots", "LuminatiChoice", "NOTSET");

            System.Diagnostics.Process proc = new Process();
            proc.StartInfo.Arguments = "-setup \"win_pdfencrypter.4dotssoftware.com\" \"Free PDF Protector 4dots\" \"" + System.IO.Path.Combine(Application.StartupPath, "free-pdf-protector-4dots-150.png") + "\"";
